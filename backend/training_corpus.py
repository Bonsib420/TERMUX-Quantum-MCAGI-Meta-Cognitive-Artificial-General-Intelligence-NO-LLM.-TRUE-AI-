...
Gravity causes objects to fall toward Earth and keeps planets in orbit around the sun.
Gravitational force depends on the mass of objects and the distance between them.
Gravity is fundamental to the structure of the universe and how celestial bodies interact.
Gravity bends spacetime according to Einstein's general theory of relativity.
...
Time is a dimension that combines with space to form the fabric of spacetime.
Time measurement began with observations of the sun moon and stars by ancient civilizations.
Time perception varies based on attention emotion and cognitive processes.
Time may be an emergent property rather than a fundamental feature of reality.
...
Space may be infinite or finite depending on the geometry of the universe.
Space contains vast empty regions between galaxies stars and planets.
Space exploration has revealed much about our solar system and beyond.
Space is not truly empty but contains quantum fluctuations and dark energy.
...
Energy sources include fossil fuels nuclear reactions solar radiation and geothermal heat.
Energy efficiency determines how much useful work can be extracted from a process.
...
Matter and energy are interconvertible according to Einstein's relativity.
Matter interacts through the four fundamental forces of nature.
Matter at the quantum level exhibits both particle and wave properties.
Matter makes up only about five percent of the total energy content of the universe.
...
Life exhibits remarkable diversity from bacteria to blue whales to giant sequoias.
Life on Earth may have originated in hydrothermal vents or from meteors.
Life is characterized by growth development adaptation and homeostasis.
Life forms complex ecosystems with intricate relationships between species.
...
Intelligence evolved as a survival advantage allowing flexible responses to challenges.
Intelligence involves memory attention pattern recognition and decision making.
Intelligence appears in varying degrees across the animal kingdom.
Intelligence is not a single ability but a collection of cognitive capacities.
...
Truth may be objective existing independently of human beliefs.
Truth theories include correspondence coherence and pragmatic approaches.
Truth is essential for knowledge which is traditionally defined as justified true belief.
Truth in science is provisional always subject to revision based on new evidence.
...
Beauty is studied in aesthetics a branch of philosophy.
Beauty is often associated with symmetry proportion and harmony.
Beautiful experiences trigger positive emotions and reward responses in the brain.
...
Love involves both emotional and physiological responses including hormone changes.
Love is associated with brain regions involved in reward and attachment.
Love can lead to both joy and suffering depending on circumstances.
Love between parents and children is fundamental to human development.
...
Freedom has been a central value in political philosophy for centuries.
Freedom can be positive having the ability to do things or negative absence of constraint.
Free will debates center on whether our choices are truly free or determined.
Freedom of speech is protected in democratic societies as essential to open discourse.
...
Knowledge can be empirical based on observation or rational based on reasoning.
Knowledge is organized into disciplines such as science philosophy and mathematics.
Knowledge is power because it enables effective action in the world.
Knowledge is social constructed and transmitted through culture and education.
...
Death is inevitable for all living organisms though timing is uncertain.
Death awareness may be unique to humans among animals.
Death rituals vary widely across cultures but all societies mark the transition.
Death can be defined in multiple ways including brain death and cardiac death.
...
Happiness involves both momentary pleasure and deeper life satisfaction.
Happiness is influenced by genetics circumstances and intentional activity.
Happiness is not the same as constant pleasure but includes contentment and purpose.
Happy people tend to be healthier more productive and more socially connected.
...
Music activates multiple brain regions and can enhance learning and memory.
Musical ability appears to have evolutionary roots and developmental stages.
Music therapy uses musical activities to achieve therapeutic goals.
Musical preferences are shaped by culture exposure and individual personality.
...
Art can challenge perceptions and provoke thought about important issues.
Artistic movements like impressionism and surrealism transformed visual culture.
Art is valued both for intrinsic beauty and cultural significance.
Artists develop skills through training but also express unique personal visions.
...
Science aims for objective truth though it is conducted by fallible humans.
Scientific theories are never proven only supported or refuted by evidence.
Scientists work within paradigms that shape what questions they ask.
Science has enabled tremendous technological progress and understanding.
...
Technology includes tools machines and techniques for solving problems.
Technological innovation drives economic growth and social change.
Technology can enhance human capabilities or replace human labor.
Technological determinism suggests that technology shapes society and culture.
...
Religion has played a central role in human history and civilization.
Religious experience includes feelings of transcendence and connection.
Religion and science have had complex relationships throughout history.
Religious fundamentalism emphasizes literal interpretation of sacred texts.
...
Philosophy includes ethics epistemology metaphysics and logic.
Philosophical questions often have no definitive answers but deepen understanding.
Philosophy examines the foundations and methods of other disciplines.
Philosophical traditions vary across cultures from Western to Eastern.
...
Mathematics is the language of science used to describe natural phenomena.
Mathematical models simplify reality to capture essential features.
Mathematics includes algebra geometry calculus and statistics.
Mathematical beauty lies in elegant proofs and surprising connections.
...
Consciousness may emerge from complex neural processes in the brain.
Conscious beings have a perspective a what it is like to be them.
Consciousness can be altered through meditation drugs or brain injury.
Conscious and unconscious processes both influence human behavior.
...
Quantum entanglement links particles across distances in strange ways.
Quantum measurement causes wave function collapse into definite states.
Quantum uncertainty means some properties cannot be known precisely.
Quantum computing uses superposition for powerful parallel processing.
...
Evolution has shaped human bodies brains and behaviors over millions of years.
Evolutionary psychology applies these insights to understanding human nature.
Evolution is supported by evidence from fossils genetics and comparative anatomy.
Evolutionary change can be gradual or punctuated by rapid transitions.
Evolution has no goal or direction only differential reproductive success.
...
Black holes bend light around them creating gravitational lensing effects.
Supermassive black holes exist at the centers of most galaxies including our Milky Way.
Black holes emit Hawking radiation slowly losing mass over immense timescales.
Stellar black holes form from stars at least twenty times more massive than our sun.
...
Neutron star matter is compressed so tightly that protons and electrons merge into neutrons.
The magnetic fields of neutron stars are trillions of times stronger than Earth's.
Neutron stars typically measure only about twenty kilometers in diameter.
A neutron star forms when a star between eight and twenty solar masses explodes.
...
Being in superposition is like existing everywhere and nowhere at the same time.
Schrodinger's cat thought experiment illustrates superposition at macroscopic scales.
Quantum computers use superposition to process many calculations simultaneously.
Superposition is destroyed by decoherence when quantum systems interact with their environment.
...
Our sun is a medium sized yellow dwarf star about halfway through its life.
Red giants are stars that have exhausted their core hydrogen and expanded.
White dwarfs are the dense remnants of stars similar to our sun.
Binary star systems contain two stars orbiting their common center of mass.
...
The cosmic microwave background is radiation from when the universe first became transparent.
The observable universe is limited by the distance light has traveled since the Big Bang.
Inflation theory suggests the universe expanded exponentially in its first fraction of a second.
The universe appears flat meaning parallel lines remain parallel over cosmic distances.
Most of the universe consists of dark matter and dark energy which remain mysterious.
