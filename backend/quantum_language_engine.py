...
idf = math.log(max(self.total_documents, 1) + 1)
...
2: 'apply',
# What happens if X is applied to Z?
3: 'analyze',
# What are the assumptions behind X?
4: 'evaluate',
# What evidence supports/contradicts X?
5: 'create',
# How could X and Y combine into something new?
}
...
# Higher stages get more sophisticated insights
