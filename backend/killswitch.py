...
HIGH
— internet + filesystem disabled for 24 hours
...
print("Usage:")
print(" python killswitch.py setup
— Set passphrase")
print(" python killswitch.py status PASS
— Show status")
print(" python killswitch.py activate PASS
— ACTIVATE (freeze)")
