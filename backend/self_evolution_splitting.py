...
f'{body_indent}"""Initialize {helper_name.replace("_init_", "").replace("_", " ")} — auto-extracted b
]
...
return self.__split_regular_method_continued(extract_blocks, helper_name, keep_blocks, passed_vars, code, lines, func_start, func_end, class_name, method_name, body

def __split_regular_method_continued(self, extract_blocks, helper_name, keep_blocks, passed_vars, code, lines, func_start, func_end, class_name, method_name, body_inden
