...
# address → bitstring
# address → concept name

# -- public API (mirrors QuantumMemoryStore) -------------------def load_concepts(self, concept_names: List[str]) -> int:
...
order = {
"bb":
[_has_bbqram, _has_select, _has_hybrid],
...
# -- public API -----------------------------------------------def load_concepts(self, concept_names: List[str]) -> int:
