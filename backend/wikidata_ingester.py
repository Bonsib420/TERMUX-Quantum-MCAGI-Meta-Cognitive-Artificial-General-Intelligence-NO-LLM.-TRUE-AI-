...
PROP_LABELS = {
    ...
    'P576': 'dissolved',    # dissolution
    'P101': 'field',        # field of work
...
def ingest_entity(title):
    ...
    print(f"    {rel_count} structured relations stored")
    return True
...
if __name__ == '__main__':
    ...
    kg = load_kg()
    print(f"Knowledge graph: {len(kg)} entities")
