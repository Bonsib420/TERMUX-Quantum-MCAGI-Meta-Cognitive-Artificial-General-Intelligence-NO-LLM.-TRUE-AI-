...
Supports:
- Arabic numeral expressions:
- Cistercian notation:
- Quadrant notation:
- Mixed:

"50 - 20", "42 + 73 =", "what is 100 * 3"
"■(50) - ■(20)", "cist(42) + cist(73)"
"{ones=2,tens=5} + {ones=3,tens=2}"
"■(50) - 20"
...
{a_lines[i]}{op_col[i]}{b_lines[i]}{eq_col[i]}{r_lines[i]}")
{op_display}
...
# ============================================================================
# Pattern for Cistercian notation: ■(123) or cist(123) or C(123)
_CIST_NUM = r'(?:■|cist|C)\((\d{1,4})\)'
...
# Pattern: ■(50) - ■(20) or cist(50) - cist(20)
...
■■ Result {result} clamped to Cistercian range: {clamped}"

lines.append(f"")
lines.append(f"■■ In Cistercian numerals: ■({a}) {op} ■({b}) = ■({clamped}){overflow_note}")
if show_ascii:
lines.append("")
...
tests = ["50 - 20", "42 + 73", "100 * 3", "9999 / 3", "what is 50 - 20", "■(50) - ■(20)"]
for t in tests:
expr = detect_math(t)
if expr:
