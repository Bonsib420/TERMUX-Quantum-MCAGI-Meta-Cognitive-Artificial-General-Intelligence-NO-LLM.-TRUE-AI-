...
# Example: {
#
"mass": {"type": "float", "min": 1.0, "max": 100.0, "units": "solar_masses", "default&quo
#
...
parameters={
"mass": {"type": "float", "min": 5.0, "max": 1000.0, "units": "solar_masses", "de
...
parameters={
"height": {"type": "float", "min": 0.5, "max": 2.0, "units": "m", "default":
"pose": {"type": "string", "options": ["standing", "walking", "t-pose"], "default
...
strategy=RenderingStrategy.HUMAN_FIGURE,
parameters={
"height": {"type": "float", "min": 1.4, "max": 2.0, "units": "m", "default":
"gender": {"type": "string", "options": ["male", "female"], "default": "person&qu
"body_type": {"type": "string", "options": ["athletic", "average", "slim"], "defa
},
visual_properties={
...
("wave", "physical", 0.4, "PARTICLE_SYSTEM", {"amplitude": {"min": 5, "max": 50, "default"
("field", "physical", 0.45, "PARTICLE_SYSTEM", {"field_strength": {"min": 0.1, "max": 1.0, "def
