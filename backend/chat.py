...
def print_full_status(api):
    ...
    stage = g.get('stage', 0)
    stage_names = ["Nascent", "Awakening", "Inquisitive", "Understanding", "Philosophical", "Theory Building", "Synthesis", "Meta-Cognition"]
    ...
    while True:
        try:
            ...
            # Cloud commands
                ...
                print("  Ingest:   /ingest URL_OR_FILE  /feed [CAT|all]")
                print("  Research: /research [status|auto N|stop|query X]")
                print("  Evolve:   /evolve")
                print("  Exam:     /exam [status|review]")
                ...
                print("  Cloud:    /cloud-save  /cloud-load  /cloud-status  /backup")
                print("  Other:    /analyze TEXT  /personality  /knowledge X  /collapse X  /test  /killswitch")
