...
/library train ID
— train on a downloaded book
/library train-all
— train on all untrained books
"""
if len(cmd_parts) < 2:
...
/library download ID TITLE
— download book by Gutenberg ID
/library list
— show downloaded books
/library train ID
— train Markov chain on a book
/library train-all
— train on all untrained books"""
...
Unknown library command. Type /library for help."
